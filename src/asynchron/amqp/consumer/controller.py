...
# import aio_pika
#
# from asynchron.amqp.context import ConsumptionContext, MessageConsumer, MessageConsumerFactory
# from asynchron.strict_typing import gather, gather_with_errors
#
