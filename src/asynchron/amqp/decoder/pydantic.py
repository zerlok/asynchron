...
#
#
# class PydanticModelMessageEncoder(MessageEncoder[T_contra, aio_pika.Message]):
#
#     def __init__(
#             self,
...
#
#
# class PydanticModelMessageDecoder(MessageDecoder[aio_pika.IncomingMessage, T_model]):
#
#     def __init__(
#             self,
...
#         self.__protocol = protocol
#
#     def decode(self, message: aio_pika.IncomingMessage) -> T_model:
